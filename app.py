...
def create_app():
    ...
    def create_parking():
        ...
        new_parking = Parking(address=address, opened=opened, count_places=count_places, count_available_places=count_available_places)
    ...
    def enter_parking():
        ...
        new_entry = ClientParking(client_id=client_id, parking_id=parking_id, time_in=datetime.now())
